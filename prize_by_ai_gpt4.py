...
def main():
    ...
    while True:
        ...
        prize = '{"title": "スプラトゥーン3若干扱い師範賞","body": "このたびはスプラトゥーン3で同年代の子たちと戦い、その中で見事な操作技術と共に勝利を収めた香純に、スプラトゥーン3若干扱い師範賞を贈ります。あなたの成長したゲームスキルとチームへの貢献は、私たち全員に感動と希望を与えてくれました。今後も更なる活躍を期待しております。心よりお祝い申し上げます。あああああああああ","org": "任天堂スプラトゥーン認定委員会"}'
        print(prize)
